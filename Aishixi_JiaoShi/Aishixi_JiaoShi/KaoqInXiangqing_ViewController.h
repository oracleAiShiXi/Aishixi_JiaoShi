//
//  KaoqInXiangqing_ViewController.h
//  Aishixi_JiaoShi
//
...
@interface KaoqInXiangqing_ViewController : UIViewController
...
@property (weak, nonatomic) IBOutlet UILabel *LanQuan;
@property (weak, nonatomic) IBOutlet UIView *LanQuan2;
